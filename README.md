...
![Ticket Portal](images/01-ticket-portal.png)  
*End user accesses the ticket portal to submit a request.*

![Ticket Details](images/01-ticket-details.png)  
*User fills in contact information, help topic, and describes the issue.*

![Ticket Confirmation](images/01-ticket-confirmation.png)  
...
![Agent Login](images/02-agent-login.png)  
*IT support agent authenticates into the osTicket agent panel.*

![Ticket Opened](images/02-ticket-opened.png)  
...
![Assign Ticket](images/04-assign-ticket.png)  
*Ticket assignment updated to reflect new ownership.*

![SysAdmin Assignment](images/04-sysadmin-assignment.png)  
*SysAdmin selected as the responsible team member.*

![Department Context](images/04-department-context.png)  
...
![Ticket History](images/05-ticket-history.png)  
...
![Resolution Notes](images/06-resolution-notes.png)  
*Detailed resolution notes documented to capture troubleshooting and fix.*

![Ticket Closed](images/06-ticket-closed.png)  
